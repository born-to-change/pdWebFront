    ...
    <div class="g-wraper" v-hljs>
      <div class="m-part">
        ...
        <ul class="info">
          ...
          <el-button type="success"  @click="addCamera()" circle>创建摄像头</el-button>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      addCamera(){
        this.$emit('addMark',this.dragData)
      },
    }
  }
</script>
...
<style scoped>
  ...
  .g-wraper{ width: 700px; margin: 0 auto; color: #666; font-size: 16px; line-height: 30px; }
  ...
  .m-part .mapbox{ width: 300px; height: 300px; margin-bottom: 20px; float: left; }
  .m-part .info{ margin: 0; padding: 0; list-style: none; line-height:20px; margin-left:5px; }
